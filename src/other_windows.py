...
class SettingsWindow(CTkToplevel):
    ...
    def draw_gui(self):
        ...
        self.header_label.place(relx=.5, rely=.4, anchor=CENTER)
        self.message_label.place(relx=.5, rely=.57, anchor=CENTER)
        self.github_label.place(relx=.5, rely=.83, anchor=CENTER)
        self.github_link.place(relx=.5, rely=.92, anchor=CENTER)
